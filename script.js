...
// Elige un par de colores planos estable a partir del texto, dentro de la
// paleta floral del sitio (coral, lavanda, mostaza, verde bosque)
const AVATAR_PALETTE = [
  { a: "#E85B3F", b: "#C23F27" }, // coral
  { a: "#B9A0DE", b: "#9679C4" }, // lavanda
  { a: "#E4A72C", b: "#C88C1B" }, // mostaza
  { a: "#3F6B4E", b: "#1F3B2A" }, // verde bosque
];

function getPaletteFromName(nombre) {
  let hash = 0;
...
function generateInitialsAvatar(nombre) {
  ...
  const { a: colorA, b: colorB } = getPaletteFromName(nombre);
